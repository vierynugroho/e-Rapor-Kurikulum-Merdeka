...
import UpdateFormIndicator from '../form/update';
import { deleteIndicator } from '@/services/pages/indicator';
...
const ActionMenu: React.FC<ActionMenuProps> = ({ data }) => {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            toast({
                title: 'Berhasil',
                description: 'Data indikator berhasil dihapus.',
                variant: 'default',
            });
            ...
            <DropdownMenuContent align="end">
                ...
                <Dialog>
                    ...
                    <DialogContent className="sm:max-w-[768px]">
                        <DialogHeader>
                            <DialogTitle>Detail Indikator</DialogTitle>
                            <DialogDescription>
                                Detail Informasi untuk {data.title}
                            </DialogDescription>
                        </DialogHeader>
                ...
                >
                    ...
                    <DialogContent className="sm:max-w-[425px] md:max-w-[768px]">
                        <DialogHeader>
                            <DialogTitle>Edit Data Indikator</DialogTitle>
                            <DialogDescription>
                                Perbarui data indikator penilaian sekolah anda
                                di sini
                            </DialogDescription>
                        </DialogHeader>
