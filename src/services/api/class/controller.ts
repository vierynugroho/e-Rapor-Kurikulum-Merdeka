...
export class ClassController {
    ...
    static async GET_ID(
        ...
        try {
            ...
            const teacher = await ClassService.GET_ID(teacherID);
    ...
    static async POST(request: Request) {
        try {
            ...
            const createPayment = await ClassService.CREATE(data);
    ...
    static async UPDATE(
        ...
        try {
            ...
            const teacher = await ClassService.UPDATE(teacherID, data);
    ...
    static async DELETE(
        ...
        try {
            ...
            const teacher = await ClassService.DELETE(teacherID);
